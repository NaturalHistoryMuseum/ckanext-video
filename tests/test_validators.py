...
class TestValidVideoURL(object):
    ...
    def test_vimeo_valid(self):
        assert is_valid_video_url('https://player.vimeo.com/video/459651092', MagicMock())
    ...
    def test_youtube_valid(self):
        assert is_valid_video_url('https://www.youtube.com/watch?v=-voP-V7YcqA', MagicMock())
    ...
    def test_youtube_embed_valid(self):
        assert is_valid_video_url('https://www.youtube.com/embed/-voP-V7YcqA', MagicMock())
